...
cure_info = {
    ...
    'early blight': 'Apply fungicides and practice crop rotation.',
    'late blight': 'Remove affected plants and use fungicides.',
    'leaf mold': 'Ensure good air circulation and apply fungicides.',
    'Septoria': 'Remove infected leaves and apply fungicides.',
    'spider mites': 'Use insecticidal soap or neem oil.',
    'target spot': 'Apply fungicides and remove affected leaves.',
    'yellow leaf': 'Ensure proper fertilization and water management.',
